...
public class In_range implements Serializable
{
    ...
    private final static long serialVersionUID = 4951577217507847813L;
     ...
     * @param min_hum
     */
    public In_range(String formatted_from, String formatted_to, Long[] hours_in_range,
        ...
        this.hours_in_range = hours_in_range;
    ...
    public In_range withFormatted_from(String formatted_from) {
        this.formatted_from = formatted_from;
        return this;
    }
    ...
    public In_range withFormatted_to(String formatted_to) {
        this.formatted_to = formatted_to;
        return this;
    }

    @JsonProperty("hours_in_range")
    public Long[] getHours_in_range() {
        return hours_in_range;
    }

    @JsonProperty("hours_in_range")
    public void setHours_in_range(Long[] hours_in_range) {
        this.hours_in_range = hours_in_range;
    }

    public In_range withHours_in_range(Long[] hours_in_range) {
        this.hours_in_range = hours_in_range;
        return this;
    }
    ...
    public In_range withAvg_temp(Double avg_temp) {
        this.avg_temp = avg_temp;
        return this;
    }
    ...
    public In_range withMax_temp(Double max_temp) {
        this.max_temp = max_temp;
        return this;
    }
    ...
    public In_range withMin_temp(Double min_temp) {
        this.min_temp = min_temp;
        return this;
    }
    ...
    public In_range withAvg_hum(Double avg_hum) {
        this.avg_hum = avg_hum;
        return this;
    }
    ...
    public In_range withMax_hum(Double max_hum) {
        this.max_hum = max_hum;
        return this;
    }
    ...
    public In_range withMin_hum(Double min_hum) {
        this.min_hum = min_hum;
        return this;
    }
